...
INSERT INTO `customer` VALUES (1,'Animesh Landge','animesh@gmail.com','Maharashtra','Mumbai','Borivali'),(2,'Soham Kotalvar','soham@gmail.com','Maharashtra','Nanded','Kalamandir'),(3,'Kunal Sachdev','kunal@gmail.com','Maharashtra','Nashik','Devlali'),(4,'Yash Jeswani','yash@gmail.com','Maharashtra','Pune','Katraj'),(5,'Amod Dhopavkar','amod@gmail.com','Maharashtra','Nagpur','8 Rasta'),(6,'Aditya Chaloo','aditya@gmail.com','Maharashtra','Pune','K.P');
...
/*!50001 VIEW `manager` AS select `customer`.`name` AS `name`,`customer`.`email` AS `email`,`customer`.`city` AS `city` from `customer` */;
...
-- Dump completed on 2019-08-07 13:10:36
